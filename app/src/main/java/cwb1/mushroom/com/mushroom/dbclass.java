...
public final class dbclass {
    ...
    public static abstract class dbabstract{
        ...
        public dbabstract(int _id, long millisec, float Accelerometer_xValue, float Accelerometer_yValue, float Accelerometer_zValue, float velocity, double longitude, double latitude, float altitude, float Magnetic_xValue, float Magnetic_yValue, float Magnetic_zValue) {
            this._id = _id;
            this.millisec = millisec;
            this.Accelerometer_xValue = Accelerometer_xValue;
            this.Accelerometer_yValue = Accelerometer_yValue;
